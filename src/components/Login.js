...
import { checkValidData } from "../validate/validate";
...
const Login = () => {
  ...
  return (
    <div>
       ...
       <form onSubmit={(e) => e.preventDefault()} className="w-full absolute md:w-3/12 p-10 bg-black my-32 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80">
